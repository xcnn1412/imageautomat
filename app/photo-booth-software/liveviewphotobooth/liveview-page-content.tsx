        ...
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden" aria-label="Liveview Photobooth — ภาพเคลื่อนไหวที่มีชีวิต">
            ...
            <div className="relative mx-auto max-w-6xl px-6">
                <nav className="flex flex-wrap items-center gap-2 text-xs uppercase tracking-[0.3em] text-white/40 mb-12">
                    ...
                    <Link href="/photo-booth-software" className="hover:text-white/70 transition-colors">ซอฟต์แวร์ Photobooth</Link>
                    <ChevronRight className="w-3 h-3" />
                    ...
                    {modes.map((mode) => (
                        ...
                        >
                            ...
                            <div className={`bg-linear-to-br ${mode.gradient} px-5 pt-5 pb-6`}>
                                {mode.badge && (
                                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-tiger-orange text-white text-[13.2px] font-bold rounded-full uppercase tracking-wider mb-2">
                                        ✦ แนะนำ
                                    </span>
                                )}
                            ...
                            <div className="px-5 py-4 flex-1 flex flex-col gap-4">
                                ...
                                <div>
                                    <p className="text-[13.2px] uppercase tracking-[0.2em] text-slate-400 mb-2">เหมาะกับงาน</p>
