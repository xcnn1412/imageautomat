...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://www.imageautomat.com/buy-photo-booth",
        type: "website",
...
function generateJsonLd() {
    ...
    return {
        ...
        "@graph": [
            {
                "@type": "ItemList",
                "@id": "https://www.imageautomat.com/buy-photo-booth#itemlist",
            ...
            {
                "@type": "BreadcrumbList",
                "@id": "https://www.imageautomat.com/buy-photo-booth#breadcrumb",
                itemListElement: [
                    {
                        "@type": "ListItem",
                        position: 1,
                    ...
                    },
                    {
                        ...
                        item: "https://www.imageautomat.com/buy-photo-booth",
                    },
                ],
            },
            {
                "@type": "FAQPage",
                "@id": "https://www.imageautomat.com/buy-photo-booth#faq",
                mainEntity: [
                    {
                        "@type": "Question",
