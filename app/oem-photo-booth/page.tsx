...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://www.imageautomat.com/oem-photo-booth",
        type: "website",
...
const jsonLd = {
    ...
    "@graph": [
        {
            "@type": "Service",
            "@id": "https://www.imageautomat.com/oem-photo-booth#service",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://www.imageautomat.com/oem-photo-booth#breadcrumb",
            itemListElement: [
                {
                    "@type": "ListItem",
                    position: 1,
                ...
                },
                {
                    ...
                    item: "https://www.imageautomat.com/oem-photo-booth",
                },
            ],
        },
        {
            "@type": "FAQPage",
            "@id": "https://www.imageautomat.com/oem-photo-booth#faq",
            mainEntity: [
                {
                    "@type": "Question",
