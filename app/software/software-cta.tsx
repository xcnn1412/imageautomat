...
export function SoftwareCta() {
    return (
        <section className="py-24 lg:py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden" aria-label="ติดต่อสอบถามซอฟต์แวร์ตู้ถ่ายรูป Photobooth">
                ...
                <div className="bg-deep-space-blue rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-6 leading-tight">
                            เริ่มต้น<span className="text-tiger-orange">ธุรกิจตู้ถ่ายรูป</span>
                            <br className="hidden md:block" />ด้วยซอฟต์แวร์ Photobooth จากเรา
                        </h2>
                        <p className="text-white/50 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
                            ติดต่อทีมงาน IMAGEAUTOMAT เพื่อรับคำปรึกษาฟรี ทดลองใช้ซอฟต์แวร์ตู้ถ่ายรูป Imageland พร้อมราคาพิเศษสำหรับผู้ที่สนใจ
                        </p>
