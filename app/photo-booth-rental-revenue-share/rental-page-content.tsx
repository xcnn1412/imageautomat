...
const HomeProgramSelection = dynamic(
    () => import("@/components/home/home_program_selection").then(mod => ({ default: mod.HomeProgramSelection })),
    { loading: () => <div className="min-h-[400px]" />, ssr: true }
)
const ReelSlideshow = dynamic(
    () => import("@/components/reel-slideshow").then(mod => ({ default: mod.ReelSlideshow })),
    { loading: () => <div className="min-h-[500px]" />, ssr: true }
)
