...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://www.imageautomat.com/photo-booth-rental-revenue-share",
        type: "website",
    ...
    alternates: {
        canonical: "https://www.imageautomat.com/photo-booth-rental-revenue-share",
    },
}
...
const jsonLd = {
    ...
    "@graph": [
        {
            "@type": "Service",
            "@id": "https://www.imageautomat.com/photo-booth-rental-revenue-share#service",
        ...
        {
            "@type": "BreadcrumbList",
            "@id": "https://www.imageautomat.com/photo-booth-rental-revenue-share#breadcrumb",
            itemListElement: [
                {
                    "@type": "ListItem",
                    position: 1,
                ...
                },
                {
                    ...
                    item: "https://www.imageautomat.com/photo-booth-rental-revenue-share",
                },
            ],
        },
        {
            "@type": "FAQPage",
            "@id": "https://www.imageautomat.com/photo-booth-rental-revenue-share#faq",
            mainEntity: [
                {
                    "@type": "Question",
