...
const stats = [
    { icon: Factory, value: "500+", label: "ตู้ที่ผลิตต่อปี" },
    { icon: Award, value: "10+", label: "ปีแห่งประสบการณ์" },
    { icon: TrendingUp, value: "50+", label: "พาร์ทเนอร์ธุรกิจ" },
]

export function OemHero() {
    return (
        <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden" aria-label="หัวข้อหน้ารับผลิตตู้โฟโต้บูธ OEM">
            {/* Background */}
            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div className="text-center max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-tiger-orange text-sm font-medium mb-8 backdrop-blur-sm border border-white/10">
                        ...
                        <span className="uppercase tracking-[0.2em]">OEM / ODM Service</span>
                    </div>

                    {/* H1 - Main Keyword */}
                    <h1 className="font-serif text-4xl md:text-5xl lg:text-7xl text-white tracking-tight leading-[1.1] mb-6">
                        รับผลิตตู้โฟโต้บูธ<br className="hidden md:block" />
                        <span className="text-tiger-orange">แบบ OEM/ODM</span>
                    </h1>

                    {/* Description */}
                    <p className="text-lg lg:text-xl text-white/50 leading-relaxed max-w-2xl mx-auto mb-12">
                        ออกแบบและผลิตตู้ถ่ายรูปตามสเปคและแบรนด์ของคุณ <br className="hidden md:block" />
                        MOQ เริ่มต้น 10 ตู้ พร้อมรับประกันคุณภาพทุกขั้นตอน
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                        ...
                        >
                            ...
                            <span className="tracking-wide">ขอใบเสนอราคา</span>
                        </a>
                        <a
                            href="#process"
                        ...
                        >
                            <span className="tracking-wide">ขั้นตอนการผลิต</span>
                        </a>
                    </div>
