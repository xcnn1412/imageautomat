  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-28 lg:px-8 lg:pt-36">
        {/* Breadcrumb */}
        <Link href="/shop-credit-card-payment" className="mb-8 inline-flex items-center gap-2 text-sm font-semibold text-deep-space-blue/50 transition-colors hover:text-deep-space-blue">
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <ul className="mt-4 grid gap-2.5 text-[17.2px] leading-snug text-deep-space-blue/70 sm:grid-cols-2">
