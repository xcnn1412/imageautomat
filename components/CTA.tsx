...
export function CTA({ isVisible = true, className = "" }: CTAProps) {
  return (
    <div className={className}>
      ...
      >
        ...
        >
          ...
          {/* Shimmer effect */}
          <span className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-linear-to-r from-transparent via-white/25 to-transparent skew-x-12" />
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            >
              {/* Phone Icon */}
              <span className="relative flex items-center justify-center w-8 h-8 rounded-full bg-linear-to-br from-tiger-orange to-tiger-orange/80 text-white shadow-sm group-hover:shadow-md group-hover:shadow-tiger-orange/30 transition-all duration-300">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 24 24"
